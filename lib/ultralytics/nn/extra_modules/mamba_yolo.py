...
from ultralytics.nn.extra_modules.attention import AGLAttention, LWA, LSKA
...
__all__ = ("VSSBlock_YOLO","VSSBlock_YOLO_AGLA","VSSBlock_YOLO_LSKA", "VSSBlock_YOLO_LWA", "SimpleStem", "VisionClueMerge", "XSSBlock")
...
class SS2D_AGLA(nn.Module):
    def __init__(
        ...
        self.attn = AGLAttention(channel=d_expand)
...
class VSSBlock_YOLO_AGLA(nn.Module):
    def __init__(
            self,
            in_channels: int = 0,
            hidden_dim: int = 0,
...
class VSSBlock_YOLO_LSKA(nn.Module):
    def __init__(
            self,
            in_channels: int = 0,
            hidden_dim: int = 0,
...
class VSSBlock_YOLO_LWA(nn.Module):
    def __init__(
            self,
            in_channels: int = 0,
            hidden_dim: int = 0,
